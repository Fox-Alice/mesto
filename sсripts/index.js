...
function addItem(evt) {
  evt.preventDefault();
  const cardSaveButton = document.querySelector('.card-popup__save-button');
  cardSaveButton.classList.add('popup__save-button_inactive');
  cardSaveButton.disabled = 'disabled';
